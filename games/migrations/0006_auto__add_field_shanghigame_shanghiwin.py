...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShanghiGame.shanghiwin'
        db.add_column('games_shanghigame', 'shanghiwin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShanghiGame.shanghiwin'
        db.delete_column('games_shanghigame', 'shanghiwin')
