...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShanghiGame.gametime'
        db.add_column('games_shanghigame', 'gametime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 12, 16, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShanghiGame.gametime'
        db.delete_column('games_shanghigame', 'gametime')
