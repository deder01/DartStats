...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        #Rename column player_num to player_number
        db.rename_column('games_shanghiplayer', 'player_num',
                         'player_number')


    def backwards(self, orm):
        # Adding field 'ShanghiPlayer.player_num'
        db.add_column('games_shanghiplayer', 'player_num',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'ShanghiPlayer.player_number'
        db.delete_column('games_shanghiplayer', 'player_number')
    ...
    models = {
        ...
        'games.shanghigame': {
            ...
            'gametime': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'num_players': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
            'shanghiwin': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'winner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'shanghigames_won'", 'null': 'True', 'to': "orm['auth.User']"})
        },
        'games.shanghiplayer': {
            ...
            'player_number': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
