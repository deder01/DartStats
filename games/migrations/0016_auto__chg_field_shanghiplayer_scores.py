...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ShanghiPlayer.scores'
        db.alter_column('games_shanghiplayer', 'scores', self.gf('django.db.models.fields.CharField')(max_length=11))

    def backwards(self, orm):

        # Changing field 'ShanghiPlayer.scores'
        db.alter_column('games_shanghiplayer', 'scores', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=12))
    ...
    models = {
        ...
        'games.shanghiplayer': {
            ...
            'scores': ('django.db.models.fields.CharField', [], {'max_length': '11'})
        }
    }
