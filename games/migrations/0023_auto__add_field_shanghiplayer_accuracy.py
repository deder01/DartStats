...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShanghiPlayer.accuracy'
        db.add_column('games_shanghiplayer', 'accuracy',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShanghiPlayer.accuracy'
        db.delete_column('games_shanghiplayer', 'accuracy')
    ...
    models = {
        ...
        'games.shanghiplayer': {
            ...
            'accuracy': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '5', 'decimal_places': '2'}),
