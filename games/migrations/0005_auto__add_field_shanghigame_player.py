...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShanghiGame.player'
        db.add_column('games_shanghigame', 'player',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='gamez', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShanghiGame.player'
        db.delete_column('games_shanghigame', 'player_id')
    ...
    models = {
        ...
        'games.shanghigame': {
            ...
            'player': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'gamez'", 'to': "orm['auth.User']"})
        },
        'games.shanghiplayer': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'player': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'shangigames'", 'to': "orm['auth.User']"}),
