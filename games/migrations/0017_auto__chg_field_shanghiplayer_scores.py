...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('games_shanghiplayer', 'scores', self.gf('django.db.models.fields.CharField')(max_length=23))
    ...
    models = {
        ...
        'games.shanghiplayer': {
            ...
            'scores': ('django.db.models.fields.CharField', [], {'max_length': '23'})
        }
    }
