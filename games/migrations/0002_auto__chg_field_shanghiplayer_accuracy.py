...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ShanghiPlayer.accuracy'
        db.alter_column('games_shanghiplayer', 'accuracy', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=4))

    def backwards(self, orm):

        # Changing field 'ShanghiPlayer.accuracy'
        db.alter_column('games_shanghiplayer', 'accuracy', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=4))
