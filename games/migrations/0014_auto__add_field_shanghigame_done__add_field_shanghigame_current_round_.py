...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ShanghiGame.current_round'
        db.add_column('games_shanghigame', 'current_round',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)

        # Adding field 'ShanghiGame.current_player'
        db.add_column('games_shanghigame', 'current_player',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ShanghiGame.current_round'
        db.delete_column('games_shanghigame', 'current_round')

        # Deleting field 'ShanghiGame.current_player'
        db.delete_column('games_shanghigame', 'current_player')
