...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShanghiGame.winner'
        db.add_column('games_shanghigame', 'winner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='shanghigames_won', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShanghiGame.winner'
        db.delete_column('games_shanghigame', 'winner_id')
    ...
    models = {
        ...
        'games.shanghigame': {
            ...
            'winner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'shanghigames_won'", 'to': "orm['auth.User']"})
        },
        'games.shanghiplayer': {
