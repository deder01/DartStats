...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ShanghiGame.winner'
        db.alter_column('games_shanghigame', 'winner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ShanghiGame.winner'
        raise RuntimeError("Cannot reverse this migration. 'ShanghiGame.winner' and its values cannot be restored.")
