...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ShanghiGame.player'
        raise RuntimeError("Cannot reverse this migration. 'ShanghiGame.player' and its values cannot be restored.")
    ...
    models = {
        ...
        'games.shanghiplayer': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'player': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'shanghiz'", 'to': "orm['auth.User']"}),
