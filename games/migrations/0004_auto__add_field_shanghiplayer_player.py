...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShanghiPlayer.player'
        db.add_column('games_shanghiplayer', 'player',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='shangigames', to=orm['auth.User']),
                      keep_default=False)
